...
myLogHook xmproc = dynamicLogWithPP . filterOutWsPP [scratchpadWorkspaceTag] $ xmobarPP
                ...
                , ppCurrent         = xmobarColor "#e0e0e0" "#782929" . pad -- #8abeb7
                , ppHidden          = xmobarColor "#e0e0e0" "#331e1e" . pad . clickable
                , ppHiddenNoWindows = xmobarColor "#70788d" ""  . clickable
                , ppTitle           = xmobarColor "#bebebe" "#782929" . shorten' " " 150 . wrap " " (take 150 $ cycle " ")
...
myborder = 
  ...
  where 
      smt         = smartBorders $ ResizableTall 1 (1/100) 0.55 [] 
      three       = ThreeColMid 1 (3/100) (1/2)
      oB          = OneBig (3/4) (3/4)
